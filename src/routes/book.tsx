...
function BookPage() {
  ...
  // Booking state
  const [booking, setBooking] = useState<string | null>(null); // trip_id being booked
...
//   onClose: () => void;
// }) {
//   // Generate a simple QR-style visual using the ticket UUID
//   const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(ticket.qr_payload)}`;
